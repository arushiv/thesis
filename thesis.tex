...
%\clearpage
%\usefont{T1}{qzc}{m}{it}
\newcommand{\thesistitle}{Understanding the genetics of gene regulation using multi-omics profiling}
...
\input{6_future_directions/main}
